      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="text-center">
              ...
              <?php else: ?>
                  <img class="card-img-top border border-secondary w-75 "  src="<?php echo site_url('admin/images/user.png'); ?>" alt="entregador sem imagem por enquanto">
              <?php endif; ?>
            ...
            <?php if($entregador->deletado_em == null): ?>
              ...
              <div class="text-center">
                <a href="<?php echo site_url("admin/entregadores/editarimagem/$entregador->id"); ?>" class="btn btn-outline-dark btn-sm mb-2 mt-2">
                  Editar imagem
            ...
            <?php else: ?>
              <a href="<?php echo site_url("admin/entregadores"); ?>" class="btn btn-light btn-sm border-dark mr-2">
                    voltar
                    <i class="mdi mdi-arrow-left btn-icon-prepend"></i>
              </a>
