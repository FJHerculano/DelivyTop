    ...
    <div class="col-lg-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <div class="ui-widget">
            <input id="query" name="query" placeholder="Pesquise por uma forma de pagamento" class="form-control bg-light mb-5 border-dark"  >
          </div>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <?php foreach($formas as $forma): ?>
                  ...
                  <td><?php echo ($forma->ativo && $forma->deletado_em == null ? '<label class="badge badge-primary">Ativo</label>' :' <label class="badge badge-warning">Desativado</label>') ?></td>
                  <td>

                    <?php echo ($forma->deletado_em === null ? '<label class="badge badge-success">Disponivel</label>' : ' <label class="badge badge-danger">Excluido</label>') ?>
