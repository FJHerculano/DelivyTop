        ...
        <div class="card-body">
          ...
          <?php if($forma->id == 1): ?>
            ...
            <div class="alert alert-primary" role="alert">
              ...
              não pode ser <span class="text-danger">edita ou excluída</span>, pois essa opção 
              será vinculada ou não o envio de troco para o cliente quando o mesmo estiver
              <strong>finalizando o pedido.</strong> 
            </div>
          ...
          <?php endif;?>
            ...
            <?php if($forma->deletado_em == null): ?>
              ...
              <a href="<?php echo site_url("admin/formas"); ?>" class="btn btn-light btn-sm border-dark">
                      voltar
            ...
            <?php else: ?>
              ...
              <a href="<?php echo site_url("admin/formas"); ?>" class="btn btn-light btn-sm border-dark mr-2">
                    voltar
                    <i class="mdi mdi-arrow-left btn-icon-prepend"></i>
              </a>
