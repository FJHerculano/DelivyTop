...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <!-- <script src="<?php echo site_url('web/');?>https://maps.googleapis.com/maps/api/js?key=AIzaSyBcg5Y2D1fpGI12T8wcbtPIsyGdw-_NV1Y&amp;callback=myMap"></script> -->
